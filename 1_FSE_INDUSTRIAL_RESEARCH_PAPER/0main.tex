...
\title{\textsc{SynthTrace}: Generating Production-Quality Kernel Traces with Constraint-Guided Diffusion Models}
...
\input{8results}
\input{9discussion}
\input{9-1-industry-vision}
\input{10threatstovalidity}
